...
# TODO: feature cols vs distance cols

class EM_Data:
    def __init__(self, positive_matching_table_train_valid, table_list_train_valid, positive_matching_table_test, table_list_test, id_names, distance_cols, feature_cols, seed, diff_sub_sample):
        # Run Matches for Train-Valid and Test
        self.generated_matches_train_valid = generate_pos_neg_matches(positive_matching_table_train_valid,\
                                                                        table_list_train_valid, \
                                                                        id_names, \
                                                                        feature_cols, \
                                                                        )

        self.generated_matches_test = generate_pos_neg_matches(positive_matching_table_test, \
                                                                table_list_test, \
                                                                id_names, \
                                                                feature_cols, \
                                                                )
        ...
        self.train_valid_sets = generate_em_train_valid_split(self.generated_matches_train_valid,\
                                                                id_names, \
                                                                feature_cols, \
                                                                difficult_cutoff, \
                                                                prop_train, \
        ...
        self.test_sets = generate_em_test_set(self.generated_matches_test,\
                                                                id_names, \
                                                                seed)
...
amazon_google_sets = EM_Data(mathces_train,
                            [amz_train, g_train],
                            mathces_test,
                            [amz_test, g_test],
                            ["id_amzn","id_g"],
