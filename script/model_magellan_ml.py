...
# TODO: generalize to quora data if possible 
# TODO: decide on trainnig and model selection 

def run_magellan_models(dataset_choice = "amazon_google", sampler = "iterative"):
    '''
    ...
    Outputs:
            CV object dictionary for every blocking options
            Dataframes for every candidate sets (to be used to evaluate precision of blockers)
